...
![image-20240329092140964](F:\note\image\image-20240329092140964.png)
...
![image-20240329110845406](F:\note\image\image-20240329110845406.png)
...
![image-20240329094402905](F:\note\image\image-20240329094402905.png)

To create a folder, end a key with `/`   创建文件加以/结尾

2.config文件夹下分别创建其它3个文件夹，以/结尾

![image-20240329094610283](F:\note\image\image-20240329094610283.png)

3.创建data文件，选择yaml格式，输入测试数据

注意空格不要使用tab键

![image-20240329101429488](F:\note\image\image-20240329101429488.png)
...
![image-20240329111348930](F:\note\image\image-20240329111348930.png)
...
![image-20240329112318091](F:\note\image\image-20240329112318091.png)

控制台打印出active.info改变，进行了刷新

![image-20240329112339760](F:\note\image\image-20240329112339760.png)
...
![image-20240329113128197](F:\note\image\image-20240329113128197.png)
...
![image-20240329113731673](F:\note\image\image-20240329113731673.png)

重新创建config/cloud-payment-service-dev/data文件配置consul

![image-20240329114024356](F:\note\image\image-20240329114024356.png)

cmd控制台输入任意键退出后重新使用管理员权限运行consul_start.bat

刷新consul页面配置依然存在。

![image-20240329114311762](F:\note\image\image-20240329114311762.png)

可以看到consul_data文件夹中生成了一些文件保存consul的快照

![image-20240329114408648](F:\note\image\image-20240329114408648.png)